...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 not-prose">
  ...
  <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center flex flex-col items-center ring-1 ring-slate-900/5 dark:ring-slate-200/10">
     ...
     <p class="text-sm text-slate-600 dark:text-slate-300">Being given treats continuously without a clear marker used or for unclear reasons loses its value as currency and causes confusion to the dog.</p> 
  </div>
  ...
  <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center flex flex-col items-center ring-1 ring-slate-900/5 dark:ring-slate-200/10">
     ...
     <p class="text-sm text-slate-600 dark:text-slate-300">Reinforcing the behavior incorrectly — marking or rewarding too late (or too early) — only reinforces the incorrect behavior. Precision is key!</p> 
  </div>
