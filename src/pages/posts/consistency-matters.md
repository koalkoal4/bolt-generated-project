...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 not-prose">
  ...
  <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center flex flex-col items-center ring-1 ring-slate-900/5 dark:ring-slate-200/10">
     ...
     <p class="text-sm text-slate-600 dark:text-slate-300">It takes much longer to train a behaviour effectively.</p>
  </div>
  ...
  <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center flex flex-col items-center ring-1 ring-slate-900/5 dark:ring-slate-200/10">
     ...
     <p class="text-sm text-slate-600 dark:text-slate-300">Commands and rules only work 'sometimes' or unpredictably.</p> {/* Adapted Text */}
  </div>
  ...
  <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center flex flex-col items-center ring-1 ring-slate-900/5 dark:ring-slate-200/10">
     ...
     <p class="text-sm text-slate-600 dark:text-slate-300">Training is a never-ending struggle.</p>
  </div>
  ...
  <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg text-center flex flex-col items-center ring-1 ring-slate-900/5 dark:ring-slate-200/10">
     ...
     <p class="text-sm text-slate-600 dark:text-slate-300">Predictability is the key for building trust; inconsistency will undermine trust.</p>
  </div>
...
<section class="space-y-8 my-12">
  ...
  <div class="relative border-l-2 border-slate-200 dark:border-slate-700 ml-4 space-y-10">
    ...
    <div class="relative pl-8">
      ...
      <h2 class="text-2xl font-semibold text-slate-800 dark:text-slate-100 mb-3">Train Consistent (Short & Sweet)</h2>
      <p class="text-lg text-slate-600 dark:text-slate-300">
