...
<p class="text-lg text-slate-600 dark:text-slate-300 mb-8">
  ...
  <ul class="list-disc list-inside ml-4 text-lg text-slate-600 dark:text-slate-300 space-y-2 mb-4">
      <li><strong>Indoors:</strong> Your living room (maybe move the coffee table!), a hallway, a quiet bedroom, or even a bathroom can work! Fewer smells and sounds than outside. I taught my dog the foundations of recall just going back and forth in our hallway – simple, but effective.</li>
      <li><strong>Controlled Outdoor Spaces:</strong> A securely fenced backyard (when calm), an empty garage, or sometimes a *completely deserted* familiar park during very off-peak hours (early morning/late night). Be mindful that even familiar outdoor spots have more distracting scents and sounds than indoors.</li>
  </ul>
